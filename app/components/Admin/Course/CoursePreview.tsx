    ...
    <div className="w-[90%] m-auto py-5 mb-5">
      ...
      <div className="w-full  text-black dark:text-white">
        ...
        <div className="w-full">
          ...
          <p className="text-[18px] mt-[208x) whitespace-pre-line w-full overflow-hidden">
        ...
        <div className="w-full flex items-center justify-between">
          <div
            className="w-full 800px:w-[188px] flex items-center justify-center h-[40px] bg-[#37a39a] text-center text-[#fff] rounded mt-8 cursor-pointer"
            onClick={() => prevButton()}
          >
            Prev
          </div>
